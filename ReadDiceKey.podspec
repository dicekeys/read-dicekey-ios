#
#  Be sure to run `pod spec lint ReadDiceKey.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  Swift library for reading DiceKeys
                   DESC

  spec.homepage     = "https://github.com/dicekeys/read-dicekey-ios"
  ...
  spec.author             = { "Nikita Titov" => "nmtitov@ya.ru" }
  # Or just: spec.author    = "Nikita Titov"
  # spec.authors            = { "Nikita Titov" => "nmtitov@ya.ru" }
  # spec.social_media_url   = "https://twitter.com/Nikita Titov"
  ...
  spec.source       = { :git => "https://github.com/dicekeys/read-dicekey-ios.git", :tag => "#{spec.version}" }
